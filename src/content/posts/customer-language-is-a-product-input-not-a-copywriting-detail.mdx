...
## Fixed inputs often flatten language

Fixed inputs tend to ask people to fit their experience into a category.
...
If it preserves the language, follows up on it, and turns it into usable context, the whole company gets better inputs.
