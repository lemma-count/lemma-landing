...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "A lead qualification form template for teams that need adaptive voice follow-up, fit signals, urgency, objections, quotes, and a sales-ready brief.",
...
const faqItems = [
  {
    question: "What should a lead qualification workflow ask?",
    answer:
          ...
          <div className="grid gap-12 md:grid-cols-[0.86fr_0.74fr] md:items-center">
            <div>
              ...
              <p className="mt-7 max-w-[730px] text-pretty text-base leading-7 text-muted md:text-lg md:leading-8">
                Use Lemma when an inbound lead needs more than firmographic
                fields. Leads answer by voice, Lemma asks follow-ups, and your
                team gets the context behind fit, urgency, and next step.
              </p>
          ...
          <div className="mt-14 grid gap-3 rounded-[18px] bg-[#f8f7f4] p-3 ring-1 ring-[#e6e3dd] md:mt-20 md:grid-cols-2 md:p-4">
            <div className="rounded-[14px] border border-[#e6e3dd] bg-white p-5 md:p-7">
              ...
              <p className="mt-4 text-sm leading-6 text-muted md:text-base md:leading-7">
                A lead fills out role, company, size, and interest. Your team
                can route the record, but still has to infer need, timing, and
                the real reason they raised a hand.
              </p>
            </div>
            <div className="rounded-[14px] border border-[#d7dcff] bg-white p-5 shadow-[0_24px_70px_-48px_rgba(61,80,255,0.85)] md:p-7">
              ...
              <p className="mt-4 text-sm leading-6 text-muted md:text-base md:leading-7">
                Lemma lets the lead explain the situation, then asks why now,
                what they tried, and what would make the next step worth taking.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-12 px-6 py-20 md:grid-cols-[0.9fr_1.1fr] md:gap-16 md:px-10 md:py-28">
          <div>
            ...
            <p className="mt-5 max-w-xl text-pretty text-base leading-7 text-muted md:text-lg md:leading-8">
              Lead qualification is most useful when the team knows what it
              needs to decide before sales follows up.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-[1280px] px-6 py-20 md:px-10 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-pretty text-base leading-7 text-muted md:text-lg md:leading-8">
              ...
              goal is to understand the leads where the next step depends on
              need, urgency, fit, or a hidden objection.
            </p>
          </div>

          <div className="mt-10 grid gap-3 md:grid-cols-3">
            {leadBriefItems.map((item) => (
              <div
                key={item}
        ...
        <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-12 px-6 py-20 md:grid-cols-2 md:gap-16 md:px-10 md:py-28">
          <div>
            ...
            <p className="mt-5 max-w-xl text-pretty text-base leading-7 text-muted md:text-lg md:leading-8">
              ...
              depends on what the person says first. Keep simple capture when
              the team only needs a structured field, routing rule, or list
              signup.
            </p>
          </div>
          ...
          <div className="grid gap-10 md:grid-cols-[1fr_auto] md:items-end">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-pretty text-base leading-7 text-white/70 md:text-lg md:leading-8">
                Turn inbound lead capture into an adaptive voice conversation
                that explains need, timing, fit, and the next best follow-up.
              </p>
            </div>
            <TrackedLink
              href="https://app.heylemma.com"
              event="cta_click"
              eventProps={{
                label: "Create the lead qualification conversation",
                page: "lead_qualification_form_template",
                location: "final_cta",
