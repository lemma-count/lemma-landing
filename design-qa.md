...
- Public release master: `/brand/lemma/v2.1.0/logo/lemma-mark-ink.svg`.
...
| Surface | Result |
| --- | --- |
| Content and composition | Passed — navigation, Brand System cards, lockups, and release references all resolve to the v2.1.0 Sunrise Threshold assets. |
